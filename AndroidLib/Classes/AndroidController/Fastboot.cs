...
namespace AndroidLib.Classes.AndroidController
{
    ...
    /// </summary>
    /// <remarks>
    ///     <para>Can only be created with <c>Fastboot.FormFastbootCommand()</c></para>
    ///     <para>
    ///         Can only be executed with <c>Fastboot.ExecuteFastbootCommand()</c> or
    ///         <c>Fastboot.ExecuteFastbootCommandNoReturn()</c>
    ///     </para>
    /// </remarks>
    public class FastbootCommand
    {
        ...
        public FastbootCommand WithTimeout(int timeout)
        {
            Timeout = timeout;
            return this;
        }
    ...
    public static class Fastboot
    {
        ...
        /// <remarks>
        ///     Should be used only for non device-specific fastboot commands such as <c>fastboot devices</c> or
        ///     <c>fastboot version</c>
        /// </remarks>
        /// <example>
        ///     This example demonstrates how to create a non device-specific <see cref="FastbootCommand" />
        ...
        /// </summary>
        /// <remarks>
        ///     Should be used only for device-specific fastboot commands such as <c>fastboot reboot</c> or
        ///     <c>fastboot getvar all</c>
        /// </remarks>
        ...
        {
            return Command.RunProcessReturnOutput(AndroidController.Instance.ResourceDirectory + FastbootExe,
        ...
        {
            Command.RunProcessNoReturn(AndroidController.Instance.ResourceDirectory + FastbootExe, command.Command,
                command.Timeout);
        }
    }
}