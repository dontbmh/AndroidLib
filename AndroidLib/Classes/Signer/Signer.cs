...
namespace AndroidLib.Classes.Signer
{
    /// <summary>
    ...
    public static class Signer
    {
        ...
        /// <returns>
        ///     True if successful, false if file <paramref name="unsigned" /> does not exist or if file
        ///     <paramref name="unsigned" /> is not a zip
        /// </returns>
        /// <remarks>
        ///     <para>Outputs signed zip in same directory as unsigned zip</para>
        /// </remarks>
        public static bool SignUpdateZip(string unsigned)
        {
            ...
            result = Java.RunJar(resDir + "signapk.jar", "\"" + resDir + "testkey.x509.pem\"",
                "\"" + resDir + "testkey.pk8\"", "\"" + unsigned + "\"",
                "\"" + unsigned.Replace(".zip", "_signed.zip\""));
